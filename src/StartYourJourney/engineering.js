...
const Engineering = (props) => {
    ...
    const [mathCourses] = useState([
        { id: 1, course: "Metallurgy", coursenumber: 2 },
        { id: 2, course: "Mechanical", coursenumber: 3 },
        { id: 3, course: "Chemical", coursenumber: 4 },
        { id: 4, course: "Electrical", coursenumber: 5 },
        { id: 5, course: "Electrical", coursenumber: 5 },
        { id: 6, course: "Electrical", coursenumber: 5 },
        { id: 7, course: "Electrical", coursenumber: 5 },
        { id: 8, course: "Electrical", coursenumber: 5 },
        { id: 9, course: "Electrical", coursenumber: 5 }
    ]);
    const selectAllFn=()=>{
    ...
    return <div className='startjourney'>
        <div className='sjhome'>
            ...
            <div className='sjtopitems'><div className='sjline'></div><div className='' onClick={() => { props.handleChange2(1) }}><div className='sjhomenuminner'>1</div></div><div className='sjline'></div><div className='' onClick={() => { props.handleChange2(2) }}><div className='sjhomenuminner'>2</div></div><div className='sjline'></div><div className='sjhomenumouter' onClick={() => { props.handleChange2(3) }}><div className='sjhomenum'>3</div></div><div className='sjline'></div><div className='' onClick={() => { props.handleChange2(4) }}><div className='sjhomenuminner'>4</div></div><div className='sjline'></div><div className='' onClick={() => { props.handleChange2(5) }}><div className='sjhomenuminner'>5</div></div><div className='sjline'></div></div>
            <div><CgProfile onClick={() => { props.handleChange2(6) }} size={"1.5rem"} color='rgba(194, 203, 219, 1)' /></div>
        </div>
        <div className='sjheader'>Engineering</div>
