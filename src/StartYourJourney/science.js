...
const Science = (props) => {
    ...
    function subjectSelectedFn(subjectid, subjectcourse) {
        setselectedSubject(oldid => [...oldid, subjectid])
        setisSelected(true)
    }
    const [mathCourses] = useState([
        { id: 1, course: "Physics", coursenumber: 2 },
        { id: 2, course: "Chemistry", coursenumber: 3 },
        { id: 3, course: "Biology", coursenumber: 4 }
    ]);
    const selectAllFn = () => {
    ...
    return <div className='startjourney'>
        <div className='sjhome'>
            ...
            <div className='sjtopitems'><div className='sjline'></div><div className='sjhomenumouter' onClick={() => { props.handleChange2(1) }}><div className='sjhomenum'>1</div></div><div className='sjline'></div><div className='' onClick={() => { props.handleChange2(2) }}><div className='sjhomenuminner'>2</div></div><div className='sjline'></div><div className='' onClick={() => { props.handleChange2(3) }}><div className='sjhomenuminner'>3</div></div><div className='sjline'></div><div className='' onClick={() => { props.handleChange2(4) }}><div className='sjhomenuminner'>4</div></div><div className='sjline'></div><div className='' onClick={() => { props.handleChange2(5) }}><div className='sjhomenuminner'>5</div></div><div className='sjline'></div></div>
            <div><CgProfile onClick={() => { props.handleChange2(6) }} size={"1.5rem"} color='rgba(194, 203, 219, 1)' /></div>
        </div>
        <div className='sjheader'>Science</div>
                            ...
                            <div className='sjcardtext'>
                                ...
                                </div>
                                {
                                    isSelected === true && selectedSubject.some((eachsub) => eachsub === mathCourse.id) ?
                                        ...
                                        :
                                        <div className='additem' onClick={() => { props.handleChange3(mathCourse.course); subjectSelectedFn(mathCourse.id, mathCourse.course); }}>
